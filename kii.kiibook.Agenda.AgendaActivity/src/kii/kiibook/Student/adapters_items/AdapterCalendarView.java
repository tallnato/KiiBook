...
public class AdapterCalendarView extends BaseAdapter {
	...
	public AdapterCalendarView(Context context,
			ArrayList<NextEventsListView> arrayList) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		listElem = (LinearLayout) view
				.findViewById(R.id._calendar_hour_elements);
		((TextView) view.findViewById(R.id.text_hour)).setText(item.getHour());

		String text = item.getElemInHour();

		TextView elemsInHour = new TextView(context);
		elemsInHour.setText(text);
		elemsInHour.setBackgroundResource(android.R.color.holo_blue_light);
