...
public class GamesFragment extends Fragment implements OnTabChangeListener {
    
    private View              mRoot;
    private GamesPagerAdapter pager;
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState ) {
        ...
        mRoot = inflater.inflate(R.layout.games_fragment, container, false);
        
        pager = new GamesPagerAdapter(inflater);
